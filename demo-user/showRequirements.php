                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Requested Requirements From User <?php echo  $_SESSION['demo_user'] ?><small></small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="x_content">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped jambo_table bulk_action">
                                                ...
                                                {
                                                    echo "<tbody>";
                                                    $sql = "select * from req_permission where project_id = '{$_SESSION['demo_proj_id']}' and p_id='{$_SESSION['demo_part_id']}' ";
