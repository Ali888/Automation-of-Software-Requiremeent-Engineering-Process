...
class Project_info{
    ...
    protected static $table_name = "participent_info";
    protected static $db_fields = array ('project_id','project_name','participent_id','participent_name','participent_role','invited');
