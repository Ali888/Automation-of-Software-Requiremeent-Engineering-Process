        ...
        <!-- page content -->
          ...
          <div class="">
            <div class="row">
              <div class="x_panel">
                  <div class="x_title">
                    <h2>weighted Table<small></small></h2>
                       ...
                       foreach ($we as $weight)
                         {
                             ...
                             ?> 
                            <td>
                               <a href="editWeight.php?post=<?php echo $weight->post."&&weight=".$weight->weight?>" >
                                <button type='submit' class='btn btn-sm btn-info' name='sub'>Edit</button></a>
                                
                                


                                 <a href="editWeight.php?post=<?php echo $weight->post.'&&action=delete'?>">
                                     <button type='submit' class='btn btn-sm btn-danger' name='sub'>Delete</button></a>
