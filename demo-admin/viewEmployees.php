                           ...
                           foreach ($res as $employee)
                            {
                               ...
                               <td>".$employee->p_designation."</td>
                               <td>".$employee->p_email."</td>"
                             ?> 
                            <td>
                               <a href="editEmployee.php?paid=<?php echo $employee->p_id."&&action=edit" ?>" >
                                <button type='submit' class='btn btn-sm btn-info' name='sub'>Edit</button></a>
                                
                                <a href="editEmployee.php?paid=<?php echo $employee->p_id."&&action=delete" ?>" >
