              ...
              <div class="x_panel">
                  ...
                  <div class="x_content">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							<div class="x_panel">
							  <div class="x_title">
								<h2>Requirements From User <?php echo  $_SESSION['user'] ?><small></small></h2>
								<ul class="nav navbar-right panel_toolbox">
								  <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
									</li>
								</ul>
								  ...
								  <table class="table table-striped jambo_table bulk_action">
									<thead>
                                      ...
                                      if(!isset($_SESSION['proj_id']))
                                      {
                                        ...
                                        {
                                            echo "<tbody>";
                                            $sql = "select * from requirements where project_id={$_SESSION['proj_id'] } and p_id={$_SESSION['part_id']}";
