        ...
        <div class="right_col" role="main">
            <div class="">
                <div class="row">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2><?php  if(isset($_SESSION['proj_name'])) echo $_SESSION['proj_name']; ?><small></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Requested Requirements From User <?php echo  $_SESSION['user'] ?><small></small></h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                            <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                            </li>
                                        </ul>
                                    ...
                                    <div class="x_content">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped jambo_table bulk_action">
                                                ...
                                                {
                                                    echo "<tbody>";
                                                    $sql = "select * from req_permission where project_id = '{$_SESSION['proj_id']}' and p_id='{$_SESSION['part_id']}' ";
                                                    $req = $requested->find_by_sql($sql);
                                                    foreach ($req as $requested)
                                                    {
                                                        echo "<tr>
                                                   <td>".$requested->project_id."</td>
                                                   <td>".$requested->project_Title."</td>
                                                   <td>".$requested->keyw."</td>
                                                    <td>"; if($requested->approve==0) echo 'Pending';
                                                       else echo 'Approve';
                                                   "</td></tr>";
