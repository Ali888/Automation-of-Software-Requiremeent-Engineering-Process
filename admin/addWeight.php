<?php
	...
	if(isset($_POST['ent']))
	{
        ...
        $res = $database->query("select * from finall where post ='{$_POST['post']}'");
        if(!$database->num_rows($res)>0){
            if($weight->create()){
                echo "<script> alert('New Role HsBeen Added'); </script>";
                echo "<script> window.open('viewProject.php','_self'); </script>";
            }

        }
        else
            echo "<script> alert('Participant Weight Is Already Available  '); </script>";
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add Weight For Employees<small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
					 <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Post Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="post" required >
                        </div>
                      </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="weight" required  >
                        </div>
                      </div>
