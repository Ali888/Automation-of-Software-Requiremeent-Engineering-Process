                                        ...
                                        <div class="x_panel">
                                            ...
                                            <div class="x_content">
                                                <div class="table-responsive">
                                                    <form action="inviteParticipents.php" method="post">
                                                        <table id="datatable-responsive"  class="table table-striped jambo_table bulk_action">
                                                            ...
                                                            {
                                                                echo "<tbody>";
                                                                $sql = "select * from partcipent_info where invited='0' and project_name='{$_SESSION['proj']}'";
                                                   ...
                                                   <td>".$partcipent->participent_role."</td></tr>";
                                                        ...
                                                        <button type="submit" class="btn btn-success" name="send">Send Invitation</button>
                                                    </form>
