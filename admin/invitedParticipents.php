...
if(isset($_GET['part']) && isset($_GET['proj'])){
    ...
    if($result_set)
        echo "<script> alert('Participant Invitation Has Been Cancelled'); 
                    window.open('invitedParticipents.php','_self');            
            </script>";
}
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="datatable-responsive"  class="table table-striped jambo_table bulk_action">
                                                        ...
                                                        if(!isset($_SESSION['proj']))
                                                        {
                                                            ...
                                                            echo "<tbody>";
                                                            $sql = "select * from partcipent_info where invited='1' and project_name='{$_SESSION['proj']}'";
                                                  ...
                                                  <td>
                                                   ...
                                                   <a href='invitedParticipents.php?part={$partcipent->participent_id}&&proj={$partcipent->project_id}'>
