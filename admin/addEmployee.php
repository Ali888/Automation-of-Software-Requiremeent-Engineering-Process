...
//     header('Location: index.php');
	if(isset($_POST['ss']))
	{
        ...
        $employee->p_name        = $_POST['p1'];
        $employee->p_email       = $_POST['p3'];
        $employee->p_designation = $_POST['p2'];

        $username = strtok($employee->p_name," ");
        do{
            $y = mt_rand(1,1000);
            $emp = $employee->find_by_sql("select * from partcipent where username ='".($username.$y)."';");
            if(sizeof($emp)>0){
                $t = true;
            }
            else{
                $employee->username = $username.$y;
                $employee->password = md5($username.$y);
                $t = false;
            }
        }while($t!=false);
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add A Employee <small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="myForm" data-parsley-validate class="form-horizontal form-label-left" method="post">

                     <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Employee Name  <span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
                               <input type="text" id="last-name"  required="required" name="p1" class="form-control col-md-7 col-xs-12">
                            </div>
                      </div>
                      
                     <div class="form-group">
							<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Employee Role <span class="required">*</span>
							</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<select id="heard" class="form-control" name="p2" required>
					  ...
					  ?>
                       ...
                       <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Employee Email <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="emailAddr"  required="required" name="p3" class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
