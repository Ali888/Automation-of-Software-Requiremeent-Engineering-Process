...
class Employee{
    ...
    protected static $table_name = "partcipent";
    protected static $db_fields = array ('p_id','p_name','p_designation','p_email','username','password');
    ...
    public static function find_by_id($id=0) {
        return self::find_by_sql("select * from ".self::$table_name." where p_id={$id} LIMIT 1");
