<?php
 ...
 $progTitle="";
    if(isset($_GET['paid']) && isset($_GET['action']))
	{
        if($_GET['action']=='edit')
        {
            $sql ="select * from partcipent_info where project_id={$_GET['pid']} and participent_id ={$_GET['paid']}";
            ...
            if($_GET['action']=='delete')
        {
            ...
            if($res)
            {
                ...
                echo " window.open('viewParticipants.php','_self'); </script>";
	...
	if(isset($_POST['ss']))
	{
        $sql ="update partcipent_info set participent_role ='{$_POST['p21']}' where project_id={$_GET['pid']} and participent_id ={$_GET['paid']}";
        $res = $database->query($sql);
        if($res)
        {
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Participant Information<small></small></h2>
                  ...
                  <div class="x_content">
                    <br />
                      ...
                      foreach ($part as $participant) {
                          $proj_name = $participant->project_name;
                          $part_name = $participant->participent_name;
                      }?>
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                     ...
                     <div class="form-group">
						    ...
						    <input type="text" id="last-name"  required="required" name="p3" class="form-control col-md-7 col-xs-12"
                            value="<?php echo $proj_name;  ?>" readonly>
                        </div>	
